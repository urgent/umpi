...
class bcn_widget extends WP_Widget
{
	...
	function __construct()
	{
		...
		$ops = array(
			'classname'   => 'widget_breadcrumb_navxt',
			'description' => __('Adds a breadcrumb trail to your sidebar', 'wokiee-core'),
		);
	...
	function widget($args, $instance)
	{
		...
		if ($instance['type'] === 'list') {
			...
			echo '</ol>';
		} elseif ($instance['type'] === 'microdata' || $instance['type'] === 'breadcrumblist_rdfa') {
