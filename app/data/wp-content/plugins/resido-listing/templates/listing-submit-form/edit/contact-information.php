    ...
    <div class="submit-section">
        <div class="row">
            ...
            <div class="form-group col-md-4">
                ...
                <input type="text" name="rlname" class="form-control" value="<?php echo $current_post->rlisting_rlname; ?>">
            </div>

            <div class="form-group col-md-4">
                <label><?php echo esc_html__('Email', 'resido-listing'); ?></label>
                <input type="email" name="rlemail" class="form-control" value="<?php echo $current_post->rlisting_email; ?>">
            </div>

            <div class="form-group col-md-4">
                <label><?php esc_html_e('Phone (optional)', 'resido-listing') ?></label>
                <input type="text" name="rlphone" class="form-control" value="<?php echo $current_post->rlisting_phone; ?>">
            </div>
            <div class="form-group col-md-4">
